...
def visualization(samples, pred, vis_dir, img_path, split_map=None):
    ...
    for idx in range(images.shape[0]):
        ...
        for p in pred[idx]:
            ...
            # print(p)
        # INSERT_YOUR_CODE
        # Put text "prediction: 몇명" at the top left corner of the image
        cv2.putText(
            sample_vis, 
            f"prediction: {len(pred[idx])}", 
...
def main(args):
    ...
    args.img_path = 'vlc-record-2025-09-11-10h57m28s-rtsp___192.168.41.16_stream1-.mp4_20251027_102727.835.jpg'
    args.resume = 'outputs/SHA/ckpt_251024/checkpoint.pth'
    args.vis_dir = '/home/sbkwon/works/PET/vis'
